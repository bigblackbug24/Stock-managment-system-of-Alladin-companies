        ...
        e.preventDefault();
            if (x < max_fields) { //max input box allowed
                x++; //text box increment
                  $(wrapper).append('<div class="col-md-2"> <input id="serial_no" type="text" class="form-control" name="serial_no" value = "' + x + '" ></div>'); //add input box
                $(wrapper).append('<div class="col-md-3"> <select name="prod_name_'+ x +'" id="prod_name_'+ x +'"  class="form-control" required onchange="return getValue();> <option value="">Select Product</option>  <?php while ($row = mysql_fetch_array($que_result_test)) { ?> <option value="<?php echo $row['product_id']; ?>"><?php echo $row['name']; ?> </option><?php } ?>  </select></div>'); //add input box                  
                $(wrapper).append('<div class="col-md-2"> <input id="quantity" type="text" class="form-control" name="qty_'+ x +'" id="qty" required onblur = "subtract(this)"></div>'); //add input box
                $(wrapper).append('<div class="col-md-2"> <input id="price" type="text" class="form-control" id="price"name="price_'+ x +'" required onblur = "subtract(this)"> </div>');
                $(wrapper).append('<div class="col-md-2">  <input id="total_cost" type="text" class="form-control" name="total_cost_'+ x +'" required>  </div>');
